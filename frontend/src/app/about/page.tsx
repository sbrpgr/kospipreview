...
const ABOUT_DESCRIPTION =
  "코스피프리뷰의 퀀트투자모델 구조, 알고리즘 파이프라인, 검증 방식, 운영 철학을 안내합니다.";
  ...
  return (
    <div className="pageContainer">
      ...
      <main className="prose">
        <h2 className="sectionTitle">코스피프리뷰 예측모델 안내</h2>
        <p>
          코스피프리뷰는 다음 거래일 코스피 시초가를 연구하기 위해 만든 퀀트투자모델 연구환경입니다. 본 서비스의 핵심 목적은
        ...
        <p>
          ...
          일관되게 해석하기 어렵다는 점입니다. 코스피프리뷰는 이 복잡한 정보를 하나의 퀀트형 예측 프레임 안에 넣고, 어떤
        ...
        <h3>5. 야간선물과의 관계</h3>
        <p>
          코스피프리뷰의 메인 예측값은 야간선물 단순추종 모델이 아닙니다. 사이트에 표시되는 야간선물 단순환산치는 별도 비교
        ...
        <p>
          코스피프리뷰는 보조지표가 성능 개선에 기여하지 못하면 자동으로 개입 강도를 줄이고, 최종 예측값이 과도하게 튀지 않도록
        ...
        <p>
          ...
          재연산, 최근 기록 검증까지 이어지는 다층 파이프라인입니다. 따라서 코스피프리뷰는 지표 몇 개를 곱하고 빼는 수준의
        ...
        <p>
          ...
          사용자 스스로 판단해야 하며, 그에 따른 책임 역시 전적으로 사용자 본인에게 있습니다. 코스피프리뷰는 미래를 보장하는

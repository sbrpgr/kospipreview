    ...
    <div className="pageContainer">
      ...
      <main className="prose">
        ...
        <p>
          ...
          기준선이며, 현재 연구 목적은 야간선물을 한 차례 브릿지 보정으로만 제한한 뒤 EWY 코어 기반 모델이 얼마나 독립적인 설명력을 가질 수
          있는지를 검증하는 데 있습니다. 즉, 야간선물 단순환산은 비교용 기준선이고, 메인 산출물은 프리장 브릿지 이후
          EWY·환율 신호를 중심으로 계산되는 예측모델 자체입니다.
        </p>

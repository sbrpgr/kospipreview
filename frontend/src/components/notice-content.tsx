...
const NOTICE_ITEMS: NoticeItem[] = [
  ...
  {
    title: "실시간 운영 로직 · 연구용 사이트가 아니라 연구환경처럼 보이는 이유",
    blocks: [
      {
        kind: "paragraph",
        text: "모델이 '연구환경'처럼 보이려면 계산식만 있어서는 안 됩니다. 기준 시점 저장, 데이터 정제, 특징량 계산, 라이브 재연산, 기록 검증, 운영 상태 구분까지 하나의 파이프라인으로 연결되어야 합니다. KOSPI Dawn은 바로 이 운영 구조까지 포함해 검증 대상으로 다룹니다.",
      },
      {
        kind: "list",
        title: "운영 파이프라인 핵심",

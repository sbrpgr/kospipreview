...
const NOTICE_ITEMS: NoticeItem[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "paragraph",
        text: "KOSPI Dawn은 완성된 고정형 서비스라기보다, 실제 데이터와 검증 기록이 쌓일수록 구조를 더 발전시켜 가는 공개 연구환경입니다. 따라서 단순히 개장가 예측에 한정하지 않고, 주식시장과 관련된 다양한 지표·모델·데이터 연구 아이디어가 있다면 문의사항을 통해 제안해 주셔도 좋습니다.",
      },
      {
        kind: "paragraph",

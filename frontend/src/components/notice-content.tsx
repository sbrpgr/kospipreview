...
const NOTICE_ITEMS: NoticeItem[] = [
  ...
  {
    title: "함께 발전시키는 플랫폼 · 원하는 지표가 있다면 문의해 주세요",
    blocks: [
      {
        kind: "paragraph",
        text: "KOSPI Dawn은 완성된 고정형 서비스라기보다, 실제 데이터와 검증 기록이 쌓일수록 구조를 더 발전시켜 가는 공개 연구환경입니다. 따라서 개장가 예측에 의미 있는 설명력을 줄 수 있다고 생각되는 지표가 있다면 문의사항을 통해 제안해 주셔도 좋습니다.",
      },
      {
        kind: "paragraph",
        text: "제안된 지표는 데이터 안정성, 수집 가능성, 지연 여부, 비용, 실제 설명력 가능성을 검토한 뒤 연구 파이프라인에 편입할 수 있는지 판단합니다. 단순히 지표를 많이 붙이는 것이 목적은 아니며, 메인 모델의 설명력을 높이거나 기존 공백 구간을 보완할 수 있는지 기준으로 검토합니다.",
      },
      {
        kind: "paragraph",
        text: "즉 이 플랫폼은 일방적으로 결과만 보여주는 페이지가 아니라, 사용자 제안과 실제 검증을 통해 점차 더 정교한 구조로 발전해 갈 수 있는 열린 연구환경입니다. 추가로 보고 싶은 지표나 비교해 보고 싶은 신호가 있다면 문의 페이지를 통해 알려 주시면 검토 후 개발 가능 여부를 살펴보겠습니다.",
      },
    ],
  },
  {
